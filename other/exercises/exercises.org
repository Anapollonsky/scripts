...
#+BEGIN_SRC python :results output
  ...
  test_bst_3 = node([108, [108, [-10, [-14], [2]], [108]], [285, [243], [285,
                                                                         None, [401]]]])
  bsts = [test_bst, test_bst_2, test_bst_3]
  ...
  def test_search(bsts):
      for func in [search_recursive, search_iterative]:
          assert bsts[2].func(108) == bsts[2].left
          assert bsts[2].func(285) == bsts[2].right
          assert bsts[2].func(143) == None
  print(bsts[2].search_iterative(108))
