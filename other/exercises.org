...
This can be made faster by searching from both sides, but building the database of neighbors is overwhelmingly the computationally-intensive part anyway. Also, either I have a limited word list, or the english vocabulary is small; I can't get from baudelaire to a.
